...
import {trendingState, userIdState,trendingState2} from '../atoms/modalAtom.'
...
//   }
  ...
  const MyList = () => {
    const trendinglist = useRecoilValue(trendingState);
    const trendinglist2 = useRecoilValue(trendingState2);
      ...
      <h1 className="text-3xl md:text-4xl grid place-items-center pt-10 pb-8">Your Favourite Movies</h1>
        {/* <h1 className="text-4xl grid place-items-center pt-10 pb-10 text-blue-400 font-serif">SELECT ANY 5 MOVIES</h1> */}
          <section className="md:space-y-8 grid place-items-center">
            <Grid userID= {userId} title="Trending Now" movies={trendinglist} />
            <Grid userID= {userId} title="Trending Now" movies={trendinglist2} />
          </section>
